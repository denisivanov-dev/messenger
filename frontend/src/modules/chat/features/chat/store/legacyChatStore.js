...
import { ref } from 'vue'
import { connect, disconnect } from '../../connection/ws/connect'
...
import { wsHandlersMap } from '../../connection/router/wsRouter'
...
export const useChatStore = defineStore('chat', () => {
  ...
  function startChat(token, mode = 'global', receiverId = null) {
    ...
    connect(token, (msg) => {
      ...
      const handler = wsHandlersMap[msg.type] || wsHandlersMap[msg.event]
      if (handler) {
        handler(msg, {
          userStore,
          messagesStore,
